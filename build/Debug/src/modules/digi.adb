M:digi
F:G$pinMode$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$digitalWrite$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$digitalRead$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$shiftIn$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$shiftOut$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldigi.digitalWrite$value$1_0$13({1}SC:U),E,0,0
S:Ldigi.digitalRead$value$1_0$25({1}SC:U),E,0,0
S:Ldigi.shiftIn$clockPin$1_0$30({3}DG,SC:U),E,0,0
S:Ldigi.shiftIn$bitOrder$1_0$30({1}SC:U),E,0,0
S:Ldigi.shiftIn$dataPin$1_0$30({3}DG,SC:U),R,0,0,[r5,r6,r7]
S:Ldigi.shiftIn$value$1_0$31({1}SC:U),R,0,0,[r4]
S:Ldigi.shiftIn$i$2_0$32({1}SC:U),R,0,0,[r3]
S:Ldigi.shiftOut$clockPin$1_0$36({3}DG,SC:U),E,0,0
S:Ldigi.shiftOut$bitOrder$1_0$36({1}SC:U),E,0,0
S:Ldigi.shiftOut$val$1_0$36({1}SC:U),E,0,0
S:Ldigi.shiftOut$dataPin$1_0$36({3}DG,SC:U),R,0,0,[r5,r6,r7]
S:Ldigi.shiftOut$i$2_0$38({1}SC:U),R,0,0,[r4]
S:Ldigi.shiftOut$sloc0$0_1$0({1}SB0$0:S),H,0,0
